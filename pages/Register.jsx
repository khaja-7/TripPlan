...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // specific navigation is handled in AuthContext
        } catch (err) {
            console.error(err);
    ...
    const googleLoginHandler = useGoogleLogin({
        onSuccess: async (tokenResponse) => {
            ...
            try {
                ...
                console.error(err);
                setError('Google login failed. Please try again.'); // Or check err details
                setIsLoading(false);
            }
        },
        onError: () => {
            ...
            <div className="hidden lg:flex w-1/2 relative overflow-hidden text-white bg-gray-950">
                <div className="absolute inset-0">
                    <img
                        ...
                        onError={(e) => e.target.src = 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?q=80&w=2070&auto=format&fit=crop'}
                    />
